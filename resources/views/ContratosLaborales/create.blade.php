            ...
            <div class="col-md-8 mx-auto">
                ...
                <div class="card">
                    ...
                    <div class="card-body px-lg-5 pt-0">
                        <form class="text-center" style="color: #757575;" action="{{route('contratos_laborales.store')}}" method="POST">
                            @csrf
                            @method("POST")
                            <div class="form-row">
                                ...
                                <div class="col">
                                    <div class="form-group mb-4">
                                        <input type="text" id="admin_id" name="admin_id_contratado" class="form-control">
